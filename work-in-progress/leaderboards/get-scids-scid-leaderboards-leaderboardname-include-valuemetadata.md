...
permalink: >-
  en-us/docs/xboxlive/rest/uri-scidsscidleaderboardsleaderboardnamegetvaluemetadata.html
ms.date: 10/12/2017
...
* [Remarks](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EY)
* [URI parameters](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EHB)
* [Query string parameters](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4ESB)
* [Authorization](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EVD)
* [Effect of privacy settings on resource](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EQE)
* [Required Request Headers](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EZE)
* [Optional Request Headers](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EOG)
* [HTTP status codes](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EOH)
* [Response headers](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4EFDAC)
* [Response body](get-scids-scid-leaderboards-leaderboardname-include-valuemetadata.md#ID4ECFAC)
...
## Query string parameters <a id="ID4ESB"></a>
...
## Effect of privacy settings on resource <a id="ID4EQE"></a>
...
| Accept | String. Content-Types that are acceptable. Example value: **application/json** |

## Optional Request Headers <a id="ID4EOG"></a>

| Header | Description |  |
| :--- | :--- | :--- |
| If-None-Match | String. Entity tag, used if client supports caching. Example value: **"686897696a7c876b7e"** |  |

## HTTP status codes <a id="ID4EOH"></a>
...
## Response headers <a id="ID4EFDAC"></a>

| Header | Type | Description |
| :--- | :--- | :--- |
| Content-Type | string | Required. The MIME type of the body of the response. Example: **application/json**. |
| Content-Length | string | Required. The number of bytes being sent in the response. Example: **232**. |
| ETag | string | Optional. Used for cache optimization. Example: **686897696a7c876b7e**. |

## Response body <a id="ID4ECFAC"></a>

### Response Members <a id="ID4EIFAC"></a>

pagingInfo \| pagingInfo\| section\| Optional. Only present when maxItems is specified in the request.\| \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| \| continuationToken\| 64-bit unsigned integer\| Required. Specifies what value to feed back into the **skipItems** query parameter to get the next page of results for that URI if desired. If no **pagingInfo** is returned then there is no next page of data to be obtained.\| \| totalItems\| 64-bit unsigned integer\| Required. Total number of entries in the leaderboard. Example value: 1234567890\|

leaderboardInfo \| leaderboardInfo\| section\| Required. Always returned. Contains the metadata about the leaderboard requested.\| \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| \| displayName\| string\| Not used.\| \| totalCount\| string \(64-bit unsigned integer\)\| Required. Total number of entries in the leaderboard. Example value: 1234567890\| \| columnDefinition\| JSON object\| Required. Describes the column in the leaderboard.\| \| columnDefinition.displayName\| string\| Required. A descriptive name of the column in the leaderboard.\| \| columnDefinition.statName\| string\| Required. The name of the user stat that the leaderboard is based on.\| \| columnDefinition.type\| string\| Required. The data type of the user stat in the column.\|

userList \| userList\| section\| Required. Always returned. Contains the actual user scores for the leaderboard requested.\| \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| --- \| \| gamertag\| string\| Required. The gamertag of the user in the leaderboard entry.\| \| xuid\| 64-bit unsigned integer\| Required. The Xbox user ID of the user in the leaderboard entry.\| \| percentile\| string\| Required. The user's percentile rank in the leaderboard.\| \| rank\| string\| Required. The user's numeric rank in the leaderboard.\| \| value\| string\| Required. The user's value of the stat on which the leaderboard is based.\| \| valueMetadata\| string\| Required. A string of comma separated string pairs, in the format "\"name\" : \"value\", ..."
...
## See also <a id="ID4E6LAC"></a>

#### Parent <a id="ID4EBMAC"></a>

[/scids/{scid}/leaderboards/{leaderboardname}](https://github.com/LucienHH/docs-xsapi/tree/8aaeb3d77dec37e3bd2a1d99ea913649665f2490/work-in-progress/leaderboards/uri-scidsscidleaderboardsleaderboardname.md)
