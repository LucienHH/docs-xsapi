...
Gets the PresenceRecord for a group. The domain for these URIs is `userpresence.xboxlive.com`.

* [Remarks](get-users-xuid-xuid-groups-moniker.md#ID4EV)
* [URI parameters](get-users-xuid-xuid-groups-moniker.md#ID4E5)
* [Query string parameters](get-users-xuid-xuid-groups-moniker.md#ID4EJB)
* [Authorization](get-users-xuid-xuid-groups-moniker.md#ID4EKC)
* [Effect of privacy settings on resource](get-users-xuid-xuid-groups-moniker.md#ID4EQD)
* [Required Request Headers](get-users-xuid-xuid-groups-moniker.md#ID4EEH)
* [Optional Request Headers](get-users-xuid-xuid-groups-moniker.md#ID4EMBAC)
* [Request body](get-users-xuid-xuid-groups-moniker.md#ID4EMCAC)
* [HTTP status codes](get-users-xuid-xuid-groups-moniker.md#ID4EXCAC)
* [Required Response Headers](get-users-xuid-xuid-groups-moniker.md#ID4E3GAC)
* [Optional Response Headers](get-users-xuid-xuid-groups-moniker.md#ID4EMJAC)
* [Response body](get-users-xuid-xuid-groups-moniker.md#ID4E5KAC)
