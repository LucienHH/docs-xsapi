...
{% api-method method="post" host="https://titlestorage.xboxlive.com" path="/untrustedplatform/users/batch/scids/{scid}/data/{pathAndFileName},{type}" %}{% api-method-description %}
